...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['mahasiswa'])->group(function () {
    Route::get('/jadwal/mahasiswa', 'JadwalController@siswa')->name('jadwal.siswa');
    Route::get('/ulangan/mahasiswa', 'UlanganController@siswa')->name('ulangan.siswa');
    Route::get('/sikap/mahasiswa', 'SikapController@siswa')->name('sikap.siswa');
    Route::get('/rapot/mahasiswa', 'RapotController@siswa')->name('rapot.siswa');
  });
  ...
  Route::middleware(['guru'])->group(function () {
    ...
    Route::get('/jadwal/dosen', 'JadwalController@guru')->name('jadwal.guru');
  ...
  Route::middleware(['admin'])->group(function () {
    Route::middleware(['trash'])->group(function () {
      ...
      Route::get('/dosen/trash', 'GuruController@trash')->name('guru.trash');
      Route::get('/dosen/restore/{id}', 'GuruController@restore')->name('guru.restore');
      Route::delete('/dosen/kill/{id}', 'GuruController@kill')->name('guru.kill');
      ...
      Route::get('/mahasiswa/trash', 'SiswaController@trash')->name('siswa.trash');
      Route::get('/mahasiswa/restore/{id}', 'SiswaController@restore')->name('siswa.restore');
      Route::delete('/mahasiswa/kill/{id}', 'SiswaController@kill')->name('siswa.kill');
    ...
    Route::get('/dosen/absensi', 'GuruController@absensi')->name('guru.absensi');
    Route::get('/dosen/kehadiran/{id}', 'GuruController@kehadiran')->name('guru.kehadiran');
    Route::get('/absen/json', 'GuruController@json');
    Route::get('/dosen/mapel/{id}', 'GuruController@mapel')->name('guru.mapel');
    Route::get('/dosen/ubah-foto/{id}', 'GuruController@ubah_foto')->name('guru.ubah-foto');
    Route::post('/dosen/update-foto/{id}', 'GuruController@update_foto')->name('guru.update-foto');
    Route::post('/dosen/upload', 'GuruController@upload')->name('guru.upload');
    Route::get('/dosen/export_excel', 'GuruController@export_excel')->name('guru.export_excel');
    Route::post('/dosen/import_excel', 'GuruController@import_excel')->name('guru.import_excel');
    Route::delete('/dosen/deleteAll', 'GuruController@deleteAll')->name('guru.deleteAll');
    Route::resource('/dosen', 'GuruController');
    Route::get('/kelas/edit/json', 'KelasController@getEdit');
    Route::resource('/kelas', 'KelasController');
    Route::get('/mahasiswa/kelas/{id}', 'SiswaController@kelas')->name('siswa.kelas');
    Route::get('/mahasiswa/view/json', 'SiswaController@view');
    Route::get('/listmahasiswapdf/{id}', 'SiswaController@cetak_pdf');
    Route::get('/mahasiswa/ubah-foto/{id}', 'SiswaController@ubah_foto')->name('siswa.ubah-foto');
    Route::post('/mahasiswa/update-foto/{id}', 'SiswaController@update_foto')->name('siswa.update-foto');
    Route::get('/mahasiswa/export_excel', 'SiswaController@export_excel')->name('siswa.export_excel');
    Route::post('/mahasiswa/import_excel', 'SiswaController@import_excel')->name('siswa.import_excel');
    Route::delete('/mahasiswa/deleteAll', 'SiswaController@deleteAll')->name('siswa.deleteAll');
    Route::resource('/mahasiswa', 'SiswaController');
    ...
    Route::get('/ulangan-mahasiswa/{id}', 'UlanganController@edit')->name('ulangan-siswa');
    ...
    Route::get('/sikap-mahasiswa/{id}', 'SikapController@edit')->name('sikap-siswa');
    ...
    Route::get('/rapot-mahasiswa/{id}', 'RapotController@edit')->name('rapot-siswa');
